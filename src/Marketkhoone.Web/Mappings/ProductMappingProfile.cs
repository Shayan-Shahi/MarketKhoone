...
namespace Marketkhoone.Web.Mappings
{
    public class ProductMappingProfile : Profile
    {
        ...
        {
            this.CreateMap<Product, ShowProductInCompareViewModel>()
                ...
                .ForMember(dest => dest.Score,
                    options =>
                        options.MapFrom(src =>
                            src.ProductComments.Any() ? src.ProductComments.Average(pc => pc.Score) : 0))
            ...
            this.CreateMap<Product, ProductItemForShowProductInComparePartialViewModel>()
