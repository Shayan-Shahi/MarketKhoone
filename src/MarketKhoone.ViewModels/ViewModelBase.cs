...
{
    public int ProductTotalCounts { get; set; }
    public int ProductVariantIsSellingNow { get; set; }
    public int OrdersNotConfirmedCounts { get; set; }
    public int UsersTotalCounts { get; set; }
    public int CommentsNotConfirmedCounts { get; set; }
    public int ReturnProductsCounts { get; set; }
}
