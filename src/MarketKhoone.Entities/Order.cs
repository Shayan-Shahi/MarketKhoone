...
public class Order : EntityBase, IAuditableEntity
{
    ...
    /// <summary>
    /// این فیلد برای بررسی کردن امکا صبت مرجوعی میباشد
    /// برای مثال این سفارش 3 مرسوله دارد
    /// مرسوله آخر در تاریه بیستم به دست مشتری میرسد
    /// تا تاریخ بیست و هفتم باید دکمه ثبت مرجوعی را به کاربر نشون بدیم
    /// این فیلد توسط مسئول حمل و نقل زمانیکه وضعیت آخرین مرسوله این سفارش را به تحویل داده تغییر میدهد، مقدار دهی میود
    /// اگر دکمه ثبت مرجوعی نمایان باشد یعنی حداقل یکی از مرسوله های این سفارش زمان مرجوع کردنش به پایان رسیده اسست
    /// </summary>
